...
- **Componentes de UI:** [Svelte 4](https://svelte.dev/)
...
- **Frameworks:** No añadir librerías sin verificar su uso previo. El proyecto utiliza Svelte 4 (no Svelte 5 actualmente).
...
---
*Este archivo es una guía dinámica y debe actualizarse si cambian las tecnologías o procesos del proyecto.*